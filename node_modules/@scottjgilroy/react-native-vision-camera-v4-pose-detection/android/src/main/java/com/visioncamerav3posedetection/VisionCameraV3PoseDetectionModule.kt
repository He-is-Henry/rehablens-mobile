...
class VisionCameraV3PoseDetectionModule(proxy : VisionCameraProxy, options: Map<String, Any>?): FrameProcessorPlugin() {
  ...
  override fun callback(frame: Frame, arguments: Map<String, Any>?): HashMap<String, Any> {
    try {
      ...
      return map.toHashMap() as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any> as HashMap<String, Any>
    } catch (e: Exception) {
